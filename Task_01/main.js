...
//==========================================================================
distanse = prompt("Enter the distance between the 2 points");
time = prompt("Enter the time you have");
alert(`You have to move with speed - ${(distanse/time).toFixed(2)}`);
//==========================================================================
const euro = 0.92;
money =prompt("Enter the dollar amount");
money *= euro;
alert(`you will get - ${money.toFixed(2)}`); 
//==========================================================================
amount_of_memory = prompt("Specify the storage volume");
